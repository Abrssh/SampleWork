...
class _PlaylistPageState extends State<PlaylistPage> {
  ...
  fetchTracks() async {
    print("Fetching");
    songs =
        await audioQuery.getSongsFromPlaylist(playlist: widget.playlistInfo);
  ...
  Widget build(BuildContext context) {
    ...
    if (loaded == true && runOnce == false) {
      print("playList Loaded : " + songs.length.toString());
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.playlistInfo.name),
